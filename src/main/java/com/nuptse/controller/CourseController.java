...
public class CourseController {
	...
	/*
	 * @RequestMapping("/course/create") public String hello() { return
	 * "course/create"; }
	 */
	@Autowired
	...
	public ModelAndView editcourse(@Valid Course course,
			BindingResult bindingResult) {
		ModelAndView modelAndView = new ModelAndView();
		// System.out.println("Course .......  " + course);
		/*
		 * Course course = courseService.findCourseByCourseName(course
		 * .getCourseName());
		 */
		System.out.println(course);
		/*
		 * if (courseExists != null) { bindingResult.rejectValue("coursename",
		 * "error.user",
	...
	public ModelAndView createNewCourse(@Valid Course course,
			BindingResult bindingResult) {
		ModelAndView modelAndView = new ModelAndView();
		System.out.println("Course .......  " + course);
		Course courseExists = courseService.findCourseByCourseName(course
				.getCourseName());
		System.out.println(course);
		if (courseExists != null) {
			bindingResult.rejectValue("coursename", "error.user",
					"There is already a course registered with the same name");
		}
		if (bindingResult.hasErrors()) {
			modelAndView.setViewName("course/create");
	 ...
	 * public ModelAndView list() { ModelAndView modelAndView = new
	 * ModelAndView(); //Course course = new Course();
	 * //modelAndView.addObject("course", course);
	 * modelAndView.setViewName("course/list"); return modelAndView; }
	 */
	/*
	 * @RequestMapping(value = "/course/list", method = RequestMethod.GET)
	 * public String index(Model md){
	 * md.addAttribute("course",service.findAll()); return "course"; }
	 */
	@RequestMapping(value = "/course/list", method = RequestMethod.GET)
